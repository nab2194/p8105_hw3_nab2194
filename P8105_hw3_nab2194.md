...
| day\_id | day       | week | activity\_day |
| ------: | :-------- | ---: | ------------: |
...
*Trends* On first glance, it looks like Fridays tend to be high activity
days on average, while Saturdays are lower in activity. It’s hard to
tell without plotting (part of why plots are important\!) but it seems
as though Week 3 was a particularly high activity week.
